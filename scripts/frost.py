...
for filename in files:
    ...
    ds = xr.open_dataset(filename, engine="cfgrib", filter_by_keys={"shortName": "max_2t", "lowerLimit": 273.0})
    ...
    for step in range(n_steps):
        ...
        # Speichern
        # --------------------------
        outname = f"warnfrost_{valid_time_local:%Y%m%d_%H%M}.png"
