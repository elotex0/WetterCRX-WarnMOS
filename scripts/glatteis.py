...
for filename in files:
    ...
    ds = xr.open_dataset(filename, engine="cfgrib", filter_by_keys={"shortName": "FZRAX"})
    data = ds["FZRAX"]
    ...
    for step in range(n_steps):
        ...
        # Speichern
        # --------------------------
        outname = f"warnglatteis_{valid_time_local:%Y%m%d_%H%M}.png"
